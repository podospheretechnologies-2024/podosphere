  ...
  return (
    <>
        ...
        <div className="container">
          <div className="page-title-content text-center">
            ...
            <p style={{ color: "var(--text-gray)" }}>
              Build bespoke software solutions tailored to your unique business needs 
              with enterprise-grade architecture and cutting-edge technology.
            </p>
            <div>
              <Link to="/contact" className="default-btn" style={{ marginRight: "15px" }}>
                Discuss Your Project <i className="bx bx-plus"></i>
              </Link>
              <Link
                to="/portfolio"
      ...
      <div className="service-detail-content">
        <div className="container">
          <h2 className="mb-5 text-center" style={{ fontSize: "2.8rem", fontWeight: "800" }}>
      ...
      <div style={{
        ...
        <div className="container">
          ...
          <p style={{ fontSize: "1.2rem", marginBottom: "30px" }}>
            Let's build software that transforms your business operations
          </p>
          <Link 
            to="/contact" 
            className="default-btn" 
